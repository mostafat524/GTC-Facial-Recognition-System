...
The scope includes preparing a facial dataset, performing exploratory data analysis, using data augmentation, and training a Convolutional Neural Network (CNN)
